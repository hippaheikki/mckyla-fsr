...
print '''<br><a href=pad2/pads.py?cur_user=%s>Return</a>''' % cur_user
...
s.close()
print '''<script>setTimeout(function() { window.location = "pad2/pads.py?cur_user=%s" }, 1000) </script>''' % cur_user
